...
export function updateRegisteredComponents() {
  ...
  globalThis.window.DSRegistry.forEach(component => component.updateStyles());
}
...
export async function setContext(arg1, arg2) {
  ...
  if (typeof arg1 === 'string' && !arg2) {
    ...
    Object.entries(data).forEach(([componentId, newComponentContext]) => {
      ...
      globalThis.window.DSContext.set(componentId, newContext);
    });
  }
  ...
  if (typeof arg1 === 'string' && typeof arg2 === 'object') {
    ...
    globalThis.window.DSContext.set(arg1, newContext);
  }
